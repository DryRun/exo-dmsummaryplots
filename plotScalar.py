...
def do_plot(Mediator,ObsOnly):
	...
	if Mediator == "Scalar":
		filepath["monojet_obs"]    = "input/CMS/Monojet/EXO-16-048/ScanMM/limit_scalar_1D.root"
		...
		filepath["METbb_DMbb_obs"] = "input/CMS/DMbb/2015/Limits_hfDMs.root"
		filepath["METbb_DMhf_obs"] = "input/CMS/DMbb/2015/Limits_hfDMs.root"
		filepath["METHF_DMhf_obs"] = "input/CMS/DMHF/2015/HF_spin0_limits.root"
		filepath["METbb_DMtt_exp"] = "input/CMS/DMbb/2015/Limits_hfDMs.root"
		filepath["METbb_DMbb_exp"] = "input/CMS/DMbb/2015/Limits_hfDMs.root"
		filepath["METbb_DMhf_exp"] = "input/CMS/DMbb/2015/Limits_hfDMs.root"
		filepath["METHF_DMhf_exp"] = "input/CMS/DMHF/2015/HF_spin0_limits.root"
		filepath["Stop_obs"]	   = "input/CMS/Stop/SUS-17-001/S_1_obs.txt"
		filepath["Stop_exp"]	   = "input/CMS/Stop/SUS-17-001/S_1_exp.txt"
	if Mediator == "Pseudo":
		filepath["monojet_obs"]    = "input/CMS/Monojet/EXO-16-048/ScanMM/limit_pseudoscalar_1D.root"
		filepath["monojet_exp"]    = "input/CMS/Monojet/EXO-16-048/ScanMM/limit_pseudoscalar_1D.root"
		filepath["monoz_obs"]      = "input/CMS/MonoZll/EXO-16-052/ScanMM/spin0/monoz_limit_P_obs.txt"
		filepath["monoz_exp"]      = "input/CMS/MonoZll/EXO-16-052/ScanMM/spin0/monoz_limit_P_exp.txt"
		filepath["DMtt_obs"]       = "input/CMS/DMtt/DMtt_Pseudo_ICHEP2016_Mx_obs.txt"
		filepath["DMtt_exp"]       = "input/CMS/DMtt/DMtt_Pseudo_ICHEP2016_Mx_exp.txt"
		filepath["METbb_DMtt_obs"] = "input/CMS/DMbb/2015/Limits_hfDMps.root"
		filepath["METbb_DMbb_obs"] = "input/CMS/DMbb/2015/Limits_hfDMps.root"
		filepath["METbb_DMhf_obs"] = "input/CMS/DMbb/2015/Limits_hfDMps.root"
		filepath["METHF_DMhf_obs"] = "input/CMS/DMHF/2015/HF_spin0_limits.root"
		filepath["METbb_DMtt_exp"] = "input/CMS/DMbb/2015/Limits_hfDMps.root"
		filepath["METbb_DMbb_exp"] = "input/CMS/DMbb/2015/Limits_hfDMps.root"
		filepath["METbb_DMhf_exp"] = "input/CMS/DMbb/2015/Limits_hfDMps.root"
		filepath["METHF_DMhf_exp"] = "input/CMS/DMHF/2015/HF_spin0_limits.root"
		filepath["Stop_obs"]	   = "input/CMS/Stop/SUS-17-001/PS_1_obs.txt"
		filepath["Stop_exp"]	   = "input/CMS/Stop/SUS-17-001/PS_1_exp.txt"
	#######################
	### Plot linestyles ###
	#######################
