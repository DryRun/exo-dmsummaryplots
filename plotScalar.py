...
if Mediator == "Scalar":
    filepath["monojet_obs"]    = "Monojet/ScanMM/forTristan/limit_1D_s_fermion.root"
    filepath["monojet_exp"]    = "Monojet/ScanMM/forTristan/limit_1D_s_fermion.root"
    filepath["monoz_obs"]      = "MonoZll/ScanMM/monoz_contour_observed_limit_scalar.root"
    filepath["monoz_exp"]      = "MonoZll/ScanMM/monoz_limit_S_exp.txt"
...
if Mediator == "Pseudo":
    filepath["monojet_obs"]    = "Monojet/ScanMM/forTristan/limit_1D_ps.root"
    filepath["monojet_exp"]    = "Monojet/ScanMM/forTristan/limit_1D_ps.root"
    filepath["monoz_obs"]      = "MonoZll/ScanMM/monoz_contour_observed_limit_pseudo.root"
    filepath["monoz_exp"]      = "MonoZll/ScanMM/monoz_limit_P_exp.txt"
...
if   Mediator == "Scalar": text["monojet_obs"] = "DM + j (fermion only) #it{[EXO-16-048]}"
elif Mediator == "Pseudo": text["monojet_obs"] = "DM + j/V_{qq} #it{[EXO-16-048]}"
text["monoz_obs"]       = "DM + Z_{ll} #it{[EXO-16-052]}"
...
text["METHF_DMhf_obs"] = "MET+tt/bb: #it{EXO-16-005} #it{B2G-15-007}"
#exp
...
for analysis in analyses: 
    ...
    elif analysis == "monoz_obs"    : tgraph[analysis] = TFile(filepath[analysis]).Get("obs")
...
tgraph["monojet_obs"].GetYaxis().SetRangeUser(0.1, 60)
...
#    for analysis in ["gen_obs","gen_exp","METbb_DMbb_obs","DMtt_obs","monojet_obs","fermion","BSM"]:
    for analysis in ["gen_obs","gen_exp","METHF_DMhf_obs","METHF_DMhf_exp","monoz_obs","monoz_exp","monojet_obs","BSM"]:
