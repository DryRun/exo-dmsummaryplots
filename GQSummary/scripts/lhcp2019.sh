#!/bin/bash
python make_plot_cms.py --cms_text Preliminary --goms 0.05,0.1,0.3,0.5,1.0  --logy --save_tag "_lhcp2019" --conference_label "LHCP 2019" 

python make_plot_cms.py --cms_text Preliminary --goms 0.05,0.1,0.3,0.5,1.0  --logy --logx --save_tag "_lhcp2019" --conference_label "LHCP 2019" 
...
EXO17026_obs,EXO18012_AK8_obs,EXO18012_CA15_obs,\
UA2,EXO17027_obs,\
CDF_Run1,_GOM5,\
CDF_Run2,B2G17017_w0p01_obs \
--save_tag "_lhcp2019" \
--conference_label "LHCP 2019"
# B2G17017_obs
...
CDF_Run1,_GOM5,\
CDF_Run2,B2G17017_w0p01_obs \
--save_tag "_lhcp2019_prelhc" \
--conference_label "LHCP 2019" \
--highlighted UA2,CDF_Run1,CDF_Run2

python make_plot_cms.py --cms_text Preliminary --goms 0.05,0.1,0.3,0.5,1.0  --logy --logx --save_tag "_lhcp2019_no16dijet" --conference_label "LHCP 2019" --analyses \
...
python make_plot_cms.py --cms_text Preliminary --goms 0.05,0.1,0.3,0.5,1.0  --logy --logx --save_tag "_lhcp2019_yes16dijet" --conference_label "LHCP 2019" --analyses \
_GOM5,B2G17017_w0p01_obs,B2G17017_w0p01_exp,\
_GOM10,EXO17027_obs,EXO17027_exp,\
EXO18012_AK8_obs,EXO18012_AK8_exp,EXO18012_CA15_obs,EXO18012_CA15_exp,\
EXO16057_SR1_obs,EXO16057_SR1_exp,\
...
python make_plot_cms_dijetlumi.py --cms_text Preliminary --goms 0.05,0.1  --logy --logx --save_tag "_lhcp2019_dijetlumi" --conference_label "LHCP 2019" --analyses \
EXO16056_narrow_lowmass_obs,\
EXO16056_narrow_lowmass_exp,\
EXO16056_narrow_highmass_obs,\
EXO16056_narrow_highmass_exp,\
...
convert -density 300 c_gq_cms_lhcp2019_logx_logy.eps c_gq_cms_lhcp2019_logx_logy.png
convert -density 300 c_gq_cms_lhcp2019_linearx_logy.eps c_gq_cms_lhcp2019_linearx_logy.png
convert -density 300 c_gq_all_2c_lhcp2019_logx_logy.eps c_gq_all_2c_lhcp2019_logx_logy.png
convert -density 300 c_gq_all_2c_lhcp2019_linearx_logy.eps c_gq_all_2c_lhcp2019_linearx_logy.png
