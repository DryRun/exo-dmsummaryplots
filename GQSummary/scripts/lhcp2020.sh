#!/bin/bash
python make_plot_cms.py --cms_text Preliminary --goms 0.05,0.1,0.3,0.5,1.0  --logy --save_tag "_lhcp2020" --conference_label "LHCP 2020" --analyses "_GOM5,B2G17017_w0p01_obs,B2G17017_w0p01_exp,\
...
python make_plot_cms.py --cms_text Preliminary --goms 0.05,0.1,0.3,0.5,1.0  --logy --logx --save_tag "_lhcp2020" --conference_label "LHCP 2020"  --analyses "_GOM5,B2G17017_w0p01_obs,B2G17017_w0p01_exp,\
_GOM10,EXO17027_obs,EXO17027_exp,\
EXO18012_AK8_obs,EXO18012_AK8_exp,EXO18012_CA15_obs,EXO18012_CA15_exp,\
EXO19004_obs,EXO19004_exp,\
EXO16057_SR1_obs,EXO16057_SR1_exp,\
